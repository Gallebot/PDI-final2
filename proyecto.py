...
effects = ["None", "Pixelado", "Cristal a cuadros", "Cilíndrica (X)", "Cilíndrica (Y)", "Eliptica (X)", "Eliptica (Y)", "Abombado", "Ondulación", "Onda", "Sobel", "Desenfoque", "Negativo", "Sepia", "Sharpen"]
